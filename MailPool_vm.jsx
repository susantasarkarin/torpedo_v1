...
function MailPool() {
  ...
  // Fetch stats
  const fetchStats = useCallback(async (accountFilter = null) => {
    ...
    try {
      ...
      let url = `${API_BASE_URL}/gmail/mail-pool/stats`
      if (accountFilter) {
  ...
  // Reload stats when account filter changes
  useEffect(() => {
    fetchStats(filterAccount || null)
  }, [filterAccount, fetchStats])
