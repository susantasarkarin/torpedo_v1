...
const COLUMN_ALIASES = {
  bill_number: ["bill_number", "bill_no", "bill no", "bill#", "vendor_invoice", "vendor_bill", "bill", "invoice_number", "invoice_no"],
...
function BillsImport() {
  ...
  const handleDownloadTemplate = () => {
    ...
    const sampleRow = "BILL-202512-0001,Supplier Inc,2025-12-21,2026-01-20,INR,50000,9000,59000,59000,pending,Office supplies"
    ...
    link.href = url
    link.download = "bills_import_template.csv"
    link.click()
  ...
  const handleImport = async () => {
    ...
    if (!columnMapping.bill_date) {
      setError("Bill Date field mapping is required")
      return
    }
  ...
  return (
    <div style={styles.container}>
      {/* Back Button */}
      <button style={styles.backButton} onClick={() => navigate("/admin/finance/bills")}>
      ...
      {step === 1 && (
        <div style={styles.card}>
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <p style={{ color: "#6b7280" }}>Select a CSV file containing your bill data</p>
          </div>
        ...
        <div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  ...
                  <p style={{ fontSize: "0.875rem", color: "#6b7280", marginTop: "0.25rem" }}>
                    Match your CSV columns to bill fields. We've auto-matched what we could.
                  </p>
                </div>
          ...
          <div style={styles.actions}>
            ...
            <button
              ...
              disabled={importing || !columnMapping.vendor_name || !columnMapping.bill_date}
              style={{
                ...styles.btnPrimary,
                ...(importing || !columnMapping.vendor_name || !columnMapping.bill_date ? styles.btnDisabled : {}),
              }}
            >
              {importing ? (
                <>
        ...
        <div style={styles.card}>
          <div style={styles.successBox}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "1rem" }}>
              ...
              <button style={styles.btnPrimary} onClick={() => navigate("/admin/finance/bills")}>
                View Bills
              </button>
            </div>
          </div>
