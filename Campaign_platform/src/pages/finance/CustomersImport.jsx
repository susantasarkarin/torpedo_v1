...
const DB_FIELDS = [
  ...
  { key: "gst_treatment", label: "GST Treatment", required: false },
  { key: "gstin", label: "GSTIN", required: false },
  { key: "pan", label: "PAN", required: false },
  { key: "billing_address_line1", label: "Billing Address", required: false },
  { key: "billing_address_city", label: "Billing City", required: false },
  { key: "billing_address_state", label: "Billing State", required: false },
  { key: "billing_address_pincode", label: "Billing Pincode", required: false },
  { key: "payment_terms", label: "Payment Terms (Days)", required: false },
...
const COLUMN_ALIASES = {
  name: ["name", "customer_name", "customername", "client_name", "clientname", "client", "customer", "company_name", "companyname", "bill_to", "billto", "party_name", "partyname"],
  customer_type: ["customer_type", "customertype", "type", "client_type", "clienttype"],
  company_name: ["company_name", "companyname", "company", "organization", "org", "business_name", "businessname"],
  email: ["email", "email_address", "emailaddress", "e-mail", "mail", "contact_email", "email_id", "emailid"],
  phone: ["phone", "phone_number", "phonenumber", "mobile", "mobile_number", "mobilenumber", "cell", "telephone", "tel", "contact_number", "contact", "mobile_no", "phone_no"],
  gst_treatment: ["gst_treatment", "gsttreatment", "gst_type", "gsttype", "tax_type", "taxtype"],
  gstin: ["gstin", "gst_number", "gstnumber", "gst_no", "gstno", "gst", "gst_in", "gstin_number"],
  pan: ["pan", "pan_number", "pannumber", "pan_no", "panno", "pan_card"],
  billing_address_line1: ["billing_address_line1", "billing_address", "billingaddress", "address", "street", "address_line1", "address1", "line1"],
  billing_address_city: ["billing_address_city", "billing_city", "billingcity", "city", "town"],
  billing_address_state: ["billing_address_state", "billing_state", "billingstate", "state", "province", "region"],
  billing_address_pincode: ["billing_address_pincode", "billing_pincode", "billingpincode", "pincode", "pin_code", "zip", "zipcode", "zip_code", "postal_code", "postalcode"],
  payment_terms: ["payment_terms", "paymentterms", "payment_days", "credit_days", "creditdays", "terms"],
  credit_limit: ["credit_limit", "creditlimit", "credit"],
  currency: ["currency", "currency_code", "currencycode"],
  opening_balance: ["opening_balance", "openingbalance", "balance", "opening_bal", "openingbal"],
  status: ["status", "active", "is_active", "isactive"],
...
function CustomersImport() {
  ...
  const handleDownloadTemplate = () => {
    ...
    const sampleRow = "Acme Corporation,business,Acme Corp,contact@acme.com,+919876543210,registered_regular,29ABCDE1234F1Z5,ABCDE1234F,123 Business Park,Mumbai,Maharashtra,400001,30,50000,INR,0,active,Key client"
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await fetch(buildApiUrl(`/finance/finance/customers/import/csv`), {
        method: "POST",
        body: formDataUpload,
      })
  ...
  return (
    <div style={styles.container}>
      {/* Back Button */}
      <button style={styles.backButton} onClick={() => navigate("/admin/finance/customers")}>
      ...
      {step === 1 && (
        <div style={styles.card}>
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <p style={{ color: "#6b7280" }}>Select a CSV file containing your customer data</p>
          </div>
        ...
        <div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  ...
                  <p style={{ fontSize: "0.875rem", color: "#6b7280", marginTop: "0.25rem" }}>
                    Match your CSV columns to customer fields. We've auto-matched what we could.
                  </p>
                </div>
          ...
          <div style={styles.actions}>
            ...
            <button
              ...
              style={{
                ...styles.btnPrimary,
                ...(importing || !columnMapping.name ? styles.btnDisabled : {}),
              }}
            >
              {importing ? (
                <>
        ...
        <div style={styles.card}>
          <div style={styles.successBox}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "1rem" }}>
              ...
              <button style={styles.btnPrimary} onClick={() => navigate("/admin/finance/customers")}>
                View Customers
              </button>
            </div>
          </div>
