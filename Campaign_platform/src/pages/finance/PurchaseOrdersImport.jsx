...
// Database fields for purchase orders
const DB_FIELDS = [
  ...
  { key: "expected_delivery", label: "Expected Delivery", required: false },
...
const COLUMN_ALIASES = {
  po_number: ["po_number", "po_no", "po no", "po#", "purchase_order_number", "purchase_order_no", "order_number", "order_no"],
  vendor_name: ["vendor_name", "vendor", "supplier_name", "supplier", "company_name", "company", "from"],
  order_date: ["order_date", "date", "po_date", "purchase_date", "created_date"],
  expected_delivery: ["expected_delivery", "delivery_date", "expected_date", "eta", "arrival_date"],
  ...
  total_amount: ["total_amount", "total", "grand_total", "amount", "po_amount"],
  status: ["status", "po_status", "order_status"],
  shipping_address: ["shipping_address", "ship_to", "delivery_address", "address"],
...
function PurchaseOrdersImport() {
  ...
  const handleDownloadTemplate = () => {
    ...
    const sampleRow = "PO-202512-0001,Supplier Inc,2025-12-21,2025-12-28,INR,50000,9000,59000,draft,123 Warehouse Street,Urgent order"
    ...
    link.href = url
    link.download = "purchase_orders_import_template.csv"
    link.click()
    URL.revokeObjectURL(url)
  }

  const handleImport = async () => {
    if (!columnMapping.vendor_name) {
      setError("Vendor Name field mapping is required")
      return
    }
    
    if (!columnMapping.order_date) {
      setError("Order Date field mapping is required")
      return
    }
  ...
  return (
    <div style={styles.container}>
      {/* Back Button */}
      <button style={styles.backButton} onClick={() => navigate("/admin/finance/purchase-orders")}>
      ...
      <div style={styles.header}>
        <h1 style={styles.title}>Import Purchase Orders</h1>
        <p style={styles.subtitle}>Upload a CSV file to import purchase orders into your database</p>
      </div>
      ...
      {step === 1 && (
        <div style={styles.card}>
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <p style={{ color: "#6b7280" }}>Select a CSV file containing your purchase order data</p>
          </div>
        ...
        <div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  ...
                  <p style={{ fontSize: "0.875rem", color: "#6b7280", marginTop: "0.25rem" }}>
                    Match your CSV columns to purchase order fields. We've auto-matched what we could.
                  </p>
                </div>
          ...
          <div style={styles.actions}>
            ...
            <button
              ...
              disabled={importing || !columnMapping.vendor_name || !columnMapping.order_date}
              style={{
                ...styles.btnPrimary,
                ...(importing || !columnMapping.vendor_name || !columnMapping.order_date ? styles.btnDisabled : {}),
              }}
            >
              {importing ? (
                <>
                ...
                <>
                  Import {csvData.length} Purchase Orders
        ...
        <div style={styles.card}>
          <div style={styles.successBox}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "1rem" }}>
              ...
              <button style={styles.btnPrimary} onClick={() => navigate("/admin/finance/purchase-orders")}>
...
export default PurchaseOrdersImport
