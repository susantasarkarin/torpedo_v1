...
async def get_app_settings(request: Request = None) -> Dict[str, Any]:
    ...
    try:
        ...
        settings = {
            ...
            # AI Providers - Gemini is FREE and default
        ...
        sensitive_fields = ["cpx_secure_hash_key", "gemini_api_keys", "openai_api_key", "anthropic_api_key", "google_sheets_service_account", "perplexity_api_key"]
...
async def save_app_settings(
    ...
    try:
        ...
        allowed_keys = [
            ...
            "gemini_api_keys", "openai_api_key", "anthropic_api_key",
